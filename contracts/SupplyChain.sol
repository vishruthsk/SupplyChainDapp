...
// gives out participants
    ...
    function addProduct(uint32 _ownerId,
        ...
        if(keccak256(abi.encodePacked(participants[_ownerId].participantType)) == keccak256("Manufacturer")) {// a string can not be compared with another string, keccak256 is used to compare the hashes 
