...
contract ERC20Token is ERC20Interface {
    ...
    function transfer(address _to, uint256 _value) public returns (bool success) {
        require(balances[msg.sender] >= _value,"Insufficient funds for transfer source.");// require is used similar to if statement  
        balances[msg.sender] -= _value;
        balances[_to] += _value;
        emit Transfer(msg.sender, _to, _value); //solhint-disable-line indent, no-unused-vars // emit is used to pop messages 
        return true;
    }
